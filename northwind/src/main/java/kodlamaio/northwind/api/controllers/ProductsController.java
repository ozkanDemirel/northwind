...
public class ProductsController {
	...
	@GetMapping("/geyByProductNameAndCategory")
	...
	@GetMapping("/geyByProductNameOrCategory")
	...
	@GetMapping("/geyByProductNameContains")
	public DataResult<List<Product>> getByProductNameContains(@RequestParam String productName) {
		return this.productService.getByProductNameContains(productName);
	}


	@GetMapping("/getByProductNameStarsWith")
	public DataResult<List<Product>> getByProductNameStarsWith(@RequestParam String productName) {
		return this.productService.getByProductNameStartsWith(productName);
	}


	@GetMapping("/geyByNameAndCategory")
